...
use crate::adapters::agent::UsageData;
...
impl crate::adapters::agent::AgentAdapter for StubAdapter {
    async fn spawn(
        &self,
        _: crate::adapters::agent::AgentConfig,
        _: tokio::sync::mpsc::Sender<oj_core::Event>,
    ) -> Result<crate::adapters::agent::AgentHandle, crate::adapters::agent::AgentAdapterError>
    {
        unimplemented!()
    }
    async fn send(
        ...
        _: &oj_core::AgentId,
        _: &str,
    ) -> Result<(), crate::adapters::agent::AgentAdapterError> {
        unimplemented!()
    }
    async fn kill(
        &self,
    ...
    async fn reconnect(
        &self,
        _: crate::adapters::agent::AgentReconnectConfig,
        _: tokio::sync::mpsc::Sender<oj_core::Event>,
    ) -> Result<crate::adapters::agent::AgentHandle, crate::adapters::agent::AgentAdapterError>
    {
        unimplemented!()
    ...
    async fn get_state(
        &self,
        _: &oj_core::AgentId,
    ) -> Result<oj_core::AgentState, crate::adapters::agent::AgentAdapterError> {
        unimplemented!()
    }
    ...
    async fn capture_output(
        ...
        _: &oj_core::AgentId,
        _: u32,
    ) -> Result<String, crate::adapters::agent::AgentAdapterError> {
        unimplemented!()
    }
