...
use oj_core::{DecisionOption, DecisionSource, Event, JobId};
...
pub(super) fn handle_decision_resolve(
    ...
    // Get the job step for StepCompleted events
    ...
    // Map chosen option to job action based on decision source
