...
use crate::agent::coop::adapter::parse_transcript_response;
use crate::agent::docker::http;
use crate::agent::log_entry::AgentLogMessage;
use crate::agent::{AgentAdapterError, AgentHandle, UsageData};
...
impl RemoteCoopClient {
    ...
    pub(crate) fn register(
        ...
        tokio::spawn(crate::agent::docker::ws::event_bridge(
            addr.clone(),
            auth_token.clone(),
            agent_id.clone(),
            owner,
    ...
    pub(crate) async fn get_state(
        ...
        Ok(crate::agent::parse_coop_agent_state(&json))
    }
